...
"\t5.\"en hc-05\" to ENABLE power of HC-05\n\r",
...
chour = 10*(__TIME__[0]-48) + (__TIME__[1]-48);		// (-48) ASCII -> dec
cmin = 10*(__TIME__[3]-48) + (__TIME__[4]-48);	
csec = 10*(__TIME__[6]-48) + (__TIME__[7]-48);	
